...
page_title: "truewatch_alert_policy_notice_date Resource - truewatch"
subcategory: ""
description: |-
  ...
  Example Usage
  ```hcl
  resource "truewatchalertpolicynoticedate" "example" {
  ...
  Lookup by name:
  ```hcl
  data "truewatchalertpolicynoticedate" "holiday" {
    name = "Holiday notice dates"
  }
...
# truewatch_alert_policy_notice_date (Resource)
